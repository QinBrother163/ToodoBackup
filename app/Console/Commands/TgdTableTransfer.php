...
class TgdTableTransfer extends Command
{
    /**
     ...
     * @var string
     */
//    protected $signature = 'tgd:transfer';
    protected $signature = 'tgd:transfer {table=all} {field=null} {primary=null} {now=null}';
    ...
    public function handle()
    {
        ...
        if (empty($field) || $field == 'null') {
            \Log::info("-e tdo:transfer $table field empty!");
            return;
        }
...
//        \Log::info('trans 1 begin');
        ...
        $srcDb = DB::connection('mysql03gztj_db_gdgd');
